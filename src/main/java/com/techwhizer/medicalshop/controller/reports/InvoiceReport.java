...
public class InvoiceReport implements Initializable {
    private final int rowsPerPage = 60;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        LocalDate prevDate = currentDate.minusDays(15);
        fromDateP.setValue(prevDate);
    ...
    private void getSaleItems(boolean isDateFilter) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                invoiceList.add(new InvoiceModel(saleMainId, 0,
